...
class RXFormBracketGuides extends Component {
    constructor(){
        super()
        this.Auth = new AuthService()
        this.state={
          serviceType: 'Orthodontic Bracket Guides',
          doctor: '',
          email: '',
          case: 0,
          address: '',
      ...
      componentWillMount(){
          ...
          if(typeof this.props.location.state == 'undefined' || !this.props.location.state.licenseAgreementAccepted){
              this.props.history.replace('/ortho-bracket-guide')
          }
      ...
      handleFormSubmit(event) {
          ...
          fetch(`${apiUrl}/rxforms`,
            ...
            if (res.status  !== 422) {
                let redirect = '/ortho-bracket-guide/upload/stl'
...
export default RXFormBracketGuides
